...
var _ShortFooter = require('./ShortFooter');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _react3.storiesOf)('Footer', module).addDecorator((0, _storybookReactRouter2.default)()).add('ShortFooter', (0, _addonInfo.withInfo)('\n      A minimal white footer. Links open new tabs or maps, or obfuscated contact methods (i.e. email.)\n      \n      ~~~js\n      <ShortFooter />\n      ~~~\n    \n    ')(function () {
    return _react2.default.createElement(_ShortFooter.ShortFooter, null);
}));